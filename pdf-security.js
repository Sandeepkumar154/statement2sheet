/**
 * Statement2Sheet PDF Security Engine
 * Real Client-Side AES-256 and RC4 Encryption & Decryption
 * Built with @pdfsmaller/pdf-encrypt v1.2.0 & @pdfsmaller/pdf-decrypt v1.0.1
 * 100% Client-Side Private (ISO 32000-2 & ISO 32000-1)
 */
(function(global) {
  "use strict";

  // 1. PDF-Encrypt Engine (Exposes global.PDFEncrypt)
/**
...
(function (root, factory) {
  ...
  // 2. PDF-Decrypt Engine (Exposes global.PDFDecrypt)
  (function() {
    let ctx_rc4 = {};
    let ctx_aes = {};
...
ctx_rc4 = { md5, RC4, hexToBytes, bytesToHex };
...
ctx_aes = { sha256, sha384, sha512, aes128CbcEncrypt, aes256CbcDecrypt, aes256CbcDecryptNoPad, aes256EcbDecryptBlock, importAES256DecryptKey, aes256CbcDecryptWithKey, computeHash2B, concat };

    })();

    // PDF Decrypt module
    (function() {
      const { PDFDocument, PDFName, PDFHexString, PDFString, PDFDict, PDFArray, PDFRawStream, PDFNumber, PDFRef } = global.PDFLib || (typeof PDFLib !== "undefined" ? PDFLib : {});
      const { md5, RC4, hexToBytes, bytesToHex } = ctx_rc4;
      const { sha256, aes256CbcDecrypt, aes256CbcDecryptNoPad, aes256EcbDecryptBlock, importAES256DecryptKey, aes256CbcDecryptWithKey, computeHash2B, concat } = ctx_aes;
...
global.PDFDecrypt = { decryptPDF, isEncrypted };
