...
- [`robots.txt`](robots.txt): Configured to allow all crawlers (`User-agent: *`, `Allow: /`) and points directly to the canonical XML sitemap:
  ...
  Sitemap: https://sandy96321.github.io/statement2sheet/sitemap.xml
  ```
- [`sitemap.xml`](sitemap.xml): Formatted per the standard Sitemaps 0.9 XML schema referencing canonical origin `https://sandy96321.github.io/statement2sheet/` with `changefreq: weekly` and `priority: 1.0`.

### B. Canonical & Social Graph Metadata
- **Canonical URL**: `<link rel="canonical" href="https://sandy96321.github.io/statement2sheet/" />` in `<head>` preventing duplicate content indexing across protocol or query variants.
- **Open Graph**: Formatted with `og:type: website`, `og:site_name`, `og:title`, `og:description`, `og:url`, and `og:image` pointing to `https://sandy96321.github.io/statement2sheet/icon.svg`.
...
1. **Access Google Search Console**:
   ...
   - Select the property: `https://sandy96321.github.io/statement2sheet/` (or add as URL prefix property).
2. **Submit Sitemap**:
...
3. **Request Homepage Indexing**:
   - Paste `https://sandy96321.github.io/statement2sheet/` into the top **URL Inspection** search bar.
...
- **Commits**:
  ...
  - `a6d431d`: Updated repository metadata to `statement2sheet`.
- **Pushed Branches**: `origin/main` and `origin/master` (both kept strictly in sync)
- **Live Endpoint Verification**:
  - `https://sandy96321.github.io/statement2sheet/` ➔ `HTTP 200 OK`
  - `https://sandy96321.github.io/statement2sheet/robots.txt` ➔ `HTTP 200 OK`
  - `https://sandy96321.github.io/statement2sheet/sitemap.xml` ➔ `HTTP 200 OK`
  - `https://sandy96321.github.io/statement2sheet/manifest.webmanifest` ➔ `HTTP 200 OK`
  - `https://sandy96321.github.io/statement2sheet/sw.js` ➔ `HTTP 200 OK`
  - `https://sandy96321.github.io/statement2sheet/app.js` ➔ `HTTP 200 OK`
  - `https://sandy96321.github.io/statement2sheet/styles.css` ➔ `HTTP 200 OK`
  - `https://sandy96321.github.io/statement2sheet/icon.svg` ➔ `HTTP 200 OK`
